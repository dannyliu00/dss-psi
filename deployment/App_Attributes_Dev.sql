...
Values 
(@GlobalApplicationID,'Java Core Service','Polaris Email Service','PolarisEmailServiceUrl','http://svc.polarisdev.com:9080/EmailService/1.0/DefaultEmailService/DefaultEmailService.wsdl')
